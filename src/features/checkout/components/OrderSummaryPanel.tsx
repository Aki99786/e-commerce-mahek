  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden sticky top-6">
      ...
      <div className="bg-gradient-to-r from-[#1a0a0a] to-[#3d1515] px-5 py-4">
        <h2 className="text-sm font-playfair font-bold text-white tracking-wide">
          Price Details
        </h2>
        <p className="text-[11px] font-poppins text-white/50 mt-0.5">
      ...
      <div className="px-5 py-4 space-y-3">
        ...
        <div className="border-t border-gray-100 pt-3 flex justify-between items-center font-poppins">
          ...
          <div className="text-right">
            ...
            <p className="text-[10px] text-gray-400 font-poppins">Incl. all taxes</p>
          </div>
        </div>
      </div>
