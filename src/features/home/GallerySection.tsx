    ...
    <section className="bg-white py-10 md:py-14 lg:py-16">
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16">
        <div className="text-center mb-8 md:mb-10">
          <p className="text-[10px] md:text-xs font-semibold uppercase tracking-widest text-rose-600 mb-2">Collections</p>
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900">Discover Our World</h2>
        </div>
        ...
        >
          ...
          <div className="absolute right-3 bottom-3 left-3 flex items-end justify-between gap-3">
            <h3 className="text-2xl text-white">Banarasi Saree</h3>
            <span className="text-xs text-white underline underline-offset-4">
              Shop Now
            </span>
          </div>
        </Link>
        ...
        <div className="flex flex-col gap-5">
          ...
          >
            ...
            <div className="absolute right-3 bottom-3 left-3 flex items-end justify-between gap-3">
              <h3 className="text-2xl text-white">Sarees</h3>
              <span className="text-xs text-white underline underline-offset-4">
                Shop Now
              </span>
            </div>
          ...
          >
            ...
            <div className="absolute right-3 bottom-3 left-3 flex items-end justify-between gap-3">
              <h3 className="text-2xl text-white">Rajputi Poshak</h3>
              <span className="text-xs text-white underline underline-offset-4">
                Shop Now
              </span>
            </div>
        ...
        <div className="flex flex-col gap-5">
          ...
          >
            ...
            <div className="absolute right-3 bottom-3 left-3 flex items-end justify-between gap-3">
              <h3 className="text-2xl text-white">Lehenga</h3>
              <span className="text-xs text-white underline underline-offset-4">
                Shop Now
              </span>
            </div>
          ...
          >
            ...
            <div className="absolute right-3 bottom-3 left-3 flex items-end justify-between gap-3">
              <h3 className="text-2xl text-white">Bridal Lehanga</h3>
              <span className="text-xs text-white underline underline-offset-4">
                Shop Now
              </span>
            </div>
      ...
      <div className="mt-8 text-center">
        <Link href={ROUTES.SHOP} className="inline-flex items-center gap-2 text-sm font-semibold text-rose-600 hover:text-rose-700 transition-colors">
          View All Products
